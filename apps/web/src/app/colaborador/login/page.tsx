import { requestLink } from "@/components/collaborator-portal/actions";
...
export default async function CollaboratorLoginPage({
  ...
  return (
    <main className="mx-auto flex max-w-sm flex-col gap-6 px-6 py-16">
      <div>
        <h1 className="text-xl font-semibold text-zinc-900 dark:text-zinc-50">Acessar como consultor externo</h1>
        <p className="mt-1 text-sm text-zinc-500 dark:text-zinc-400">
          Informe o e-mail para o qual você recebeu um convite — enviaremos um link de acesso.
        </p>
      </div>
      ...
      {sent === "1" && (
        <p className="rounded-md border border-zinc-200 bg-white p-3 text-sm text-zinc-700 dark:border-zinc-800 dark:bg-zinc-950 dark:text-zinc-300">
          Se o e-mail estiver cadastrado como consultor, você receberá um link de acesso em instantes. Ele vale por
          15 minutos.
        </p>
      )}
