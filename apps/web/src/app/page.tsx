const modules = [
  { name: "Office", desc: "Integração com Google Workspace" },
  { name: "CRM", desc: "Captação e relacionamento com clientes" },
  { name: "ERP Arquitetura", desc: "Projetos, equipe e financeiro" },
  { name: "FF&E", desc: "Especificação e orçamento de mobiliário" },
];
