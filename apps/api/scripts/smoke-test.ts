...
async function main() {
  ...
  // plano inteiro") -- portal só-leitura totalmente separado do resto da
  // API, ver collaborator-portal/. ---------------------------------------
  ...
  const collabProjectsNoAuthRes = await fetch(`${BASE_URL}/v1/collaborator-portal/projects`);
  report(
    "GET /collaborator-portal/projects sem X-Collaborator-Session → 401",
    collabProjectsNoAuthRes.status === 401
  );

  const collabProjectsRes = await fetch(`${BASE_URL}/v1/collaborator-portal/projects`, {
  ...
  const collabProjectDetailRes = await fetch(`${BASE_URL}/v1/collaborator-portal/projects/${projectId}`, {
    headers: { "X-Collaborator-Session": collaboratorSessionToken },
  });
  ...
  const collabWrongProjectRes = await fetch(`${BASE_URL}/v1/collaborator-portal/projects/does-not-exist`, {
    headers: { "X-Collaborator-Session": collaboratorSessionToken },
  });
  report(
  ...
  const collabProjectsAfterRevokeRes = await fetch(`${BASE_URL}/v1/collaborator-portal/projects`, {
    headers: { "X-Collaborator-Session": collaboratorSessionToken },
  });
  ...
  const collabProjectDetailAfterRevokeRes = await fetch(`${BASE_URL}/v1/collaborator-portal/projects/${projectId}`, {
    headers: { "X-Collaborator-Session": collaboratorSessionToken },
  });
  report(
